  ...
  <div>
    <Drawer>
      <DrawerTrigger
        :class="
          cn(
            'flex w-full cursor-pointer items-center justify-center rounded-full px-6 py-2.5 font-heading text-sm',
            classes?.outer
          )
        "
      >
      ...
      <DrawerContent
        :class="
          cn(
            'mx-auto !max-h-4/5 !rounded-t-2xl pt-2 pb-10 text-center xs:max-w-[414px]',
            classes?.wrapper
          )
        "
      >
