...
<template>
  <Teleport to="body">
    ...
    <Transition name="slide-up">
      ...
      >
        <div
          class="pointer-events-auto min-w-[400px] overflow-hidden rounded-xl bg-white shadow-2xl transition-colors duration-300 dark:bg-neutral-950 dark:ring-1 dark:ring-white/10"
        >
