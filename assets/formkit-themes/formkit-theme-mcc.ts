...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:box__decorator': {
    ...
    'peer-checked:text-text-primary': true,
  ...
  'family:dropdown__listbox': {
    ...
    'group-data-[overscroll]:border-border-primary': true,
  ...
  select__input: {
    ...
    'group-data-[prefix-icon]:!pl-0': true,
    'group-data-[suffix-icon]:!pr-0': true,
    'data-[placeholder]:text-text-primary': true,
    'dark:text-neutral-100': true,
  ...
  tel__input: {
    ...
    'text-base': true,
    'placeholder:text-neutral-400': true,
    'placeholder:font-normal': true,
    'placeholder:text-base': true,
    'dark:placeholder:text-neutral-500': true,
  },
  tel__help: {
    'text-text-primary': true,
  ...
  autocomplete__selectionWrapper: {
    ...
    'group-data-[multiple]:border-border-primary': true,
  ...
  colorpicker__fieldGroup: {
    ...
    '[&>input]:p-1': true,
    '[&>input]:text-sm': true,
    '[&>input]:text-text-primary': true,
    '[&>input]:m-0': true,
    '[&>input]:grow': true,
    '[&>input]:shrink': true,
    '[&>input]:w-full': true,
    '[&>input]:border': true,
    '[&>input]:border-border-primary': true,
  ...
  datepicker__calendarIcon: {
    'text-neutral-600': true,
    'focus-visible:text-text-primary': true,
    flex: true,
    'w-[1em]': true,
    'grow-0': true,
    'shrink-0': true,
  ...
  transferlist__outer: {
    ...
    'dark:[&_.dnd-placeholder]:text-text-primary': true,
  },
  ...
  'multi-step__tabs': {
    ...
    'group-data-[tab-style=tab]/wrapper:border-border-primary': true,
